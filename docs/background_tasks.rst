...
While we are not planning to support different queue jobs libraries in the near future, it should be quite easy to use queue libraries. This can usually be done by subclassing the feeds manager.
